...
describe("Likes", () => {
  it("should add a like to the like counter of the repository", async () => {
    ...
    expect(getByTestId(`repository-likes-${repositoryId}`)).toHaveTextContent("Repository Likes: 1");
    ...
    expect(getByTestId(`repository-likes-${repositoryId}`)).toHaveTextContent("Repository Likes: 2");
  });
});
